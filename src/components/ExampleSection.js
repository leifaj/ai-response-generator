  ...
  return (
      <section className="exampleSection">
        <div className="exampleTitle">
          ...
          <div className="tooltip"><p>Input some text, and the AI model will generate a text completion. It'll try to match whatever context or pattern it's given! You might get a slightly different completion every time you call it, even with the same prompt.</p></div>
        </div>
